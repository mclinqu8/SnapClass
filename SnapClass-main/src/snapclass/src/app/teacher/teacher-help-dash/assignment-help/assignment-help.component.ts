...
@Component({
  selector: 'app-assignment-help',
  templateUrl: './assignment-help.component.html',
  styleUrls: ['./assignment-help.component.css']
})
export class AssignmentHelpComponent implements OnInit {
  ...
  rubricManagement = routeNames.RUBRICMANAGEMENT;
